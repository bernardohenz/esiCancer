...
bool Cell::getHasSuppressorMut() const
{
    return hasSuppressorMut;
}

void Cell::setHasSuppressorMut(bool value)
{
    hasSuppressorMut = value;
}
...
float Cell::getSinergy() const
{
    return sinergy;
}

void Cell::setSinergy(float value)
{
    sinergy = value;
}
...
void Cell::setupParams(float tid, float tprobOfRep, float tprobOfDeath, float tmutationPerRep, unsigned int ttelomeres, int maxIdMutation)
{
    ...
    firstTapeMutations = std::vector<unsigned int>();//(maxIdMutation,false);
    secondTapeMutations = std::vector<unsigned int>();//(maxIdMutation,false);
...
Cell::Cell(float tid, float tprobOfRep, float tprobOfDeath, float tmutationPerRep, unsigned int ttelomeres, std::vector<unsigned int> tmutationsInOrder, std::vector<unsigned int> tFirstTapeMutations, std::vector<unsigned int> tSecondTapeMutations, std::vector<long> tparentsOrder)
{
    setupParams(tid,tprobOfRep,tprobOfDeath,tmutationPerRep,ttelomeres);
    //initialize mutations
    mutationsInOrder =tmutationsInOrder;
    firstTapeMutations = tFirstTapeMutations;
    secondTapeMutations = tSecondTapeMutations;
...
std::vector<unsigned int> Cell::getFirstTapeMutations() const
{
    return firstTapeMutations;
}

void Cell::setFirstTapeMutations(const std::vector<unsigned int> &value)
{
    firstTapeMutations = value;
}

std::vector<unsigned int> Cell::getSecondTapeMutations() const
{
    return secondTapeMutations;
}

void Cell::setSecondTapeMutations(const std::vector<unsigned int> &value)
{
    secondTapeMutations = value;
}
